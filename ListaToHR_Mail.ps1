...
#alvállalkozok lekérdezése, és excelbe töltése.
$sh.Cells.item($j,1).formulaLocal = "Alvállalkozók:"
$j++
$sh.Cells.item($j,1).formulaLocal = "DisplayName"		
$sh.Cells.item($j,2).formulaLocal = "SamAccountName"	
$sh.Cells.item($j,4).formulaLocal = "Department"		
$sh.Cells.item($j,5).formulaLocal = "Title"
$sh.Cells.item($j,6).formulaLocal = "Manager"
Get-User -OrganizationalUnit "kfki.corp/kfki/felhasznalok/Alvallalkozok" | foreach-object `
{ 
...
#alvállalkozok lekérdezése, és excelbe töltése.
$sh.Cells.item($j,1).formulaLocal = "Egységesítés miatt felvett felhasználók:"
$j++
$sh.Cells.item($j,1).formulaLocal = "DisplayName"		
$sh.Cells.item($j,2).formulaLocal = "SamAccountName"	
$sh.Cells.item($j,4).formulaLocal = "Department"		
$sh.Cells.item($j,5).formulaLocal = "Title"
$sh.Cells.item($j,6).formulaLocal = "Manager"
Get-User -OrganizationalUnit "kfki.corp/kfki/felhasznalok/KFKI_EGYSEGESITES" | foreach-object `
{ 
